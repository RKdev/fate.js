...
var today = new Date();
encounter.enc.title.push(today);

engine.registerGame('fateland');
engine.loadGame('fateland');

encounter.register('title','joe');
encounter.register('characters', 'bob');
...
engine.objs.games[0].checkDM('');
engine.objs.games[0].DM('', 'release');
engine.objs.games[0].DM('fenris', 'catch');
engine.objs.games[0].checkDM('fenris');
